...
logger = create_logger(__name__, 'RV_Calculation.log')

class StrategyRV(BaseStrategy):
        ...
        with Session(engine) as db_session:
            ...
            try:
                try:
                    ...
                    df_nifty["RV"] = (round(df_nifty["log_ret"].rolling(window=10).std() * np.sqrt(252*375),5)*100)
                    print(self.interval)
