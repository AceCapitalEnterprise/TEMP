...
# Initialize logger
logger = create_logger(__name__, 'p3_cash_strategy_live.log')
...
# --- Main Strategy Class ---
class StrategyP3Cash(BaseStrategy):
    def __init__(self, params):
        ...
        try:
            ...
            self.kite.login()
            logger.info("Zerodha initialized successfully for P3 Cash Strategy")
    ...
    def run(self, deployed_strategy_id: int) -> None:
        ...
        log_msg = f"========== STARTING P3 EXECUTION #{self.run_count} AT {current_time} =========="
        logger.info(log_msg)
        ...
        with Session(engine) as db_session:
            ...
            try:
                ...
                # P3 relies on stock_daily.csv and nifty_data.csv produced by P1.
                ...
                logger.error(f"Error during P3 scheduled execution:", exc_info=e)