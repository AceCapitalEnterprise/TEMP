...
logger = create_logger(__name__, 'trading_straddle_strategy_15_Lag_PaperTrade.log')

class StrategyStraddleFifteenLagPaperFivePaisa(BaseStrategy):
    def __init__(self, params):
        ...
        self.temp_file="open_position_15_lag_paper.csv"
