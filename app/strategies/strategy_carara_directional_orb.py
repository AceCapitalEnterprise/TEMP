...
logger = create_logger(__name__, 'trading_carara_directional_orb_strategy.log')


class StrategyCararaDirectionalOrb(BaseStrategy):
    def __init__(self, params):
        ...
        self.PATH_CE = "unclosed_positions_carara_directional_ce.csv"
        self.PATH_PE = "unclosed_positions_carara_directional_pe.csv"
