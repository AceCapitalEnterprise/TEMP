...
logger = create_logger(__name__, 'trading_Sarlasinghal_directional_orb_strategy.log')


class StrategySarlasinghalDirectionalOrb(BaseStrategy):
    def __init__(self, params):
        ...
        self.PATH_CE = "unclosed_positions_Sarlasinghal_directional_ce.csv"
        self.PATH_PE = "unclosed_positions_Sarlasinghal_directional_pe.csv"
