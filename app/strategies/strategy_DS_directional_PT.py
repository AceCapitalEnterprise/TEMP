...
class StrategyDirectionalPTOrb(BaseStrategy):
    def __init__(self, params):
        ...
        self.PATH_CE = "unclosed_positions_PT_directional_ce.csv"
        self.PATH_PE = "unclosed_positions_PT_directional_pe.csv"
        ...
        try:
            ...
            for index, position in positions_df.iterrows():
                ...
                if current_price >= position['trailing_sl']:
                    ...
                    pnl= position['premium']-execution_price
    ...
    def closest_put_otm(self):
        ...
        try:
            strikes = [self.ATM_STRIKE - i for i in range(200, 1100, 50)]
            ltps = []
                        ...
                        if self.TIME_1 < now.time() <= self.TIME_2 and now.time().second == 0:
                            if self.positions_df_pe.empty and self.ADDING_POS:
                                try:
                                    ...
                                    if (last_row['close'] > resistance) and (last_row['close']>moving_avg+25): #Change entry condition for Put
                                        ...
                                        if closest_strike_pe:
                                            ...
                                            if last['close'] <= sup and 20 < last['close'] < 25 :
                            ...
                            if self.positions_df_ce.empty and self.ADDING_POS:
                                try:
                                    ...
                                    if (last_row['close'] < support) and (last_row['close']< moving_avg-25): #Change entry condition for Call
                                        self.ATM_STRIKE = round(last_row['close'] / 50) * 50
