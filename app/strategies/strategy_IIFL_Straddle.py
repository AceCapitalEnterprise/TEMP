...
logger = create_logger(__name__, 'trading_IIFL_RPS_Delta_straddle_strategy.log')
...
class StrategyStraddleIIFL(BaseStrategy):
    def __init__(self, params):
        ...
        self.temp_file  = "open_position_RPS_IIFL_Delta.csv"
        self.PROFIT_CUT_QTY =  int(self.QTY/2)
        self.ROUND_OFF      = 50
