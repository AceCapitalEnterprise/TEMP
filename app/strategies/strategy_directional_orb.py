...
logger = create_logger(__name__, 'trading_directional_orb_strategy.log')


class StrategyRpsDirectionalOrb(BaseStrategy):
    def __init__(self, params):
        ...
        self.PATH_CE = "unclosed_positions_directional_ce.csv"
        self.PATH_PE = "unclosed_positions_directional_pe.csv"
